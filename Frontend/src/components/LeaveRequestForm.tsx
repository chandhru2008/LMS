...
function LeaveRequestForm() {
  ...
  if (leaveForm.fromDate && leaveForm.toDate) {
    const days = calculateBusinessDays(leaveForm.fromDate, leaveForm.toDate);
    setRequestedDays(days);

    const balance = leaveBalances.find((b) => b.type === leaveForm.leaveTypeName);
    if (!balance) {
    ...
    setHasSufficientLeaveBalance(true); // or false, depending on your logic
  }
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 mt-3">
                  {leaveBalances.map((leave) => (
                    <div
                      ...
                      className={`p-3 rounded-lg border transition-all ${leave.remaining === 0
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 block w-full rounded-md shadow-sm py-2 px-3 border ${formErrors.fromDate ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-indigo-500"
                  }`}
              />
              {formErrors.fromDate && (
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`mt-1 block w-full rounded-md shadow-sm py-2 px-3 border ${formErrors.toDate ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-indigo-500"
                  }`}
              />
              {formErrors.toDate && (
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className={`mt-1 block w-full rounded-md shadow-sm py-2 px-3 border ${formErrors.reason ? "border-red-300 focus:ring-red-500" : "border-gray-300 focus:ring-indigo-500"
                }`}
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${isSubmitting || !hasSufficientLeaveBalance
