  ...
  return (
    <div className="w-[70%] mx-auto my-6">
      <div className="flex justify-between items-center mb-6 px-2">
        <h2 className="text-2xl font-semibold text-gray-800">Manager Pending Leave Requests</h2>
      </div>

      <div className="flex flex-col gap-4">
        {leaveRequests.filter(req => req.leaveDetails.approvalStatus.managerApproval === "Pending").length === 0 ? (
          <p className="text-gray-500 text-center">No pending leave requests</p>
        ) : (
          leaveRequests
            .filter(req => req.leaveDetails.approvalStatus.managerApproval === "Pending")
