  ...
  return (
    <div className="w-[70%] mx-auto my-6">
      ...
      <div className="flex flex-col gap-4">
        {leaveRequests.filter(req => req.leaveDetails.approvalStatus.directorApproval === "Pending").length === 0 ? (
          <p className="text-gray-500 text-center">No pending leave requests</p>
        ) : (
          leaveRequests
            .filter(req => req.leaveDetails.approvalStatus.directorApproval === "Pending")
