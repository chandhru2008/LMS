...
function LeaveRequestDirector() {
  ...
  useEffect(() => {
    async function fetchLeaveRequests() {
      try {
        const res = await fetch("https://lms-zwod.onrender.com/all-leave-requests", {
          method: "GET",
          credentials: "include",
        });
        const json = await res.json();
        setLeaveRequests(json || []);
      } catch (err) {
  ...
  return (
    <div className="w-[70%] mx-auto my-6">
      <div className="flex justify-between items-center mb-6 px-2">
        <h2 className="text-2xl font-semibold text-gray-800">Leave Requests (Director)</h2>
          ...
          filteredRequests.map(({ employeeDetails, leaveDetails }) => (
            ...
            >
              ...
              <div className="px-5 py-4 space-y-3">
                ...
                {leaveDetails.approvalStatus.directorApproval === "Pending" && (
